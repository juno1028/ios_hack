...
class DiarySecondViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//    }
    @IBAction func addAction(_ sender: UIButton) {
        ...
        let alert =  UIAlertController(title: "사진 선택", message: "사진을 선택해 주세요.", preferredStyle: .actionSheet)
